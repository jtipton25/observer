...
\begin{figure}
\centering\includegraphics[width=0.95\linewidth]{tipton-06-10-2016_files/figure-latex/simPlot-1.pdf}
...
```{r PCASSVSSim, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
...
```{r PCALassoSim, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100),
...
```{r tPCASSVSSim, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100))
}
...
```{r tPCALassoSim, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100),
       gamma2=matrix(rgamma(p*t, 1, 1), p, t), lambda2=rexp(t))
}
...
```{r pPCASSVSSim, cache=TRUE, echo=FALSE, cache.lazy=FALSE, eval=TRUE}
jinits <- function(){
...
```{r pPCALassoSim, cache=TRUE, echo=FALSE, cache.lazy=FALSE, eval=TRUE}
jinits <- function(){
...
```{r tpPCASSVSSim, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){   
...
```{r tpPCALassoSim, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t),  s_inv=runif(1, 0, 100),
...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{tipton-06-10-2016_files/figure-latex/pPCAreconstruction-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{tipton-06-10-2016_files/figure-latex/pPCAreconstructionSurfaces-1.pdf}
...
```{r PCASSVSObserver, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100))
}
...
```{r PCALassoObserver, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100),
       gamma2=matrix(rgamma(p*t, 1, 1), p, t), lambda2 = rexp(t))
} 
...
```{r tPCASSVSObserver, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100))
}
...
```{r tPCALassoObserver, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100),
       gamma2=matrix(rgamma(p*t, 1, 1), p, t), lambda2 = rexp(t))
}
...
```{r pPCASSVSObserver, cache=TRUE, echo=FALSE, cache.lazy=FALSE, eval=TRUE}
jinits <- function(){
  list(s_beta_inv=runif(1, 0, 100), beta=matrix(rnorm(p, 0, 10), p, t),
       tau_inv=runif(t, 0, 100), s_inv=runif(1, 0, 100))
}
...
```{r pPCALassoObserver, cache=TRUE, echo=FALSE, cache.lazy=FALSE, eval=TRUE}
jinits <- function(){ 
...
```{r tpPCASSVSObserver, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){   
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(1, 0, 100), 
       tau_inv=runif(t, 0, 100)) }
...
```{r tpPCALassoObserver, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t),  s_inv=runif(1, 0, 100),
       tau_inv=runif(t, 0, 100), gamma2=matrix(rgamma(p*t, 1, 1), p, t),
       lambda2=rexp(t))
...
```{r PCASSVSOutlier, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100))
}
...
```{r PCALassoOutlier, eval=TRUE, cache=TRUE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100),
       gamma2=matrix(rgamma(p*t, 1, 1), p, t), lambda2 = rexp(t))
} 
...
```{r tPCASSVSOutlier, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100))
}
...
```{r tPCALassoOutlier, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(t, 0, 100),
       gamma2=matrix(rgamma(p*t, 1, 1), p, t), lambda2 = rexp(t))
}
...
```{r pPCASSVSOutlier, cache=TRUE, echo=FALSE, cache.lazy=FALSE, eval=TRUE}
jinits <- function(){
  list(s_beta_inv=runif(1, 0, 100), beta=matrix(rnorm(p, 0, 10), p, t),
       tau_inv=runif(t, 0, 100), s_inv=runif(1, 0, 100))
}
...
```{r pPCALassoOutlier, cache=TRUE, echo=FALSE, cache.lazy=FALSE, eval=TRUE}
jinits <- function(){ 
  list(beta=matrix(rnorm(t*p, 0, 10), p, t), tau_inv=runif(t, 0, 100), 
       s_inv=dunif(1, 0, 100))
}
...
```{r tpPCASSVSOutlier, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){   
  list(beta=matrix(rnorm(p, 0, 10), p, t), s_inv=runif(1, 0, 100), 
       tau_inv=runif(t, 0, 100)) }
...
```{r tpPCALassoOutlier, cache=TRUE, cache.lazy=FALSE, echo=FALSE, eval=TRUE}
jinits <- function(){
  list(beta=matrix(rnorm(p, 0, 10), p, t),  s_inv=runif(1, 0, 100),
       tau_inv=runif(t, 0, 100), gamma2=matrix(rgamma(p*t, 1, 1), p, t),
       lambda2=rexp(t))
...
plot_k(loo_tppca_lasso_fort$pareto_k, main="LASSO robust pPCR", ylim=c(0, 3.25),
       cex.axis=1.5, cex.main=1.5, cex.lab=1.5)
mtext("(a)",side=3,line=-1.9,adj=c(0.1),cex=2,col="black")
plot_k(loo_tppca_lasso_outlier$pareto_k, main="LASSO robust pPCR outlier removed", ylim=c(0, 3.25), 
       cex.axis=1.5, cex.main=1.5, cex.lab=1.5)
mtext("(b)",side=3,line=-1.9,adj=c(0.1),cex=2,col="black")
```
...
\begin{figure}
\centering\includegraphics[width=0.95\linewidth]{tipton-06-10-2016_files/figure-latex/fortPlotsDiff-1.pdf}
...
\begin{figure}
\centering\includegraphics[width=0.95\linewidth]{tipton-06-10-2016_files/figure-latex/TimeSeries-5.pdf}
