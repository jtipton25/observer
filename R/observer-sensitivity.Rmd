...
\begin{figure}
\centering\includegraphics[width=0.95\linewidth]{observer-sensitivity_files/figure-latex/loo_fort2-1.pdf}
...
time.dat <- data.frame(
  ...
  model = rep(c(rep("robust PCA", 75), rep("robust pPCA", 75)), times=4),
...
grid.text("(a)", x = unit(0.95, "npc"), 
          y = unit(.95, "npc"))#,gp = gpar(fontsize=20, fontfamily="Times New Roman"))
grid.text("(b)", x = unit(0.95, "npc"), 
          y = unit(.25, "npc"))#,gp = gpar(fontsize=20, fontfamily="Times New Roman"))
...
\begin{figure}
\centering\includegraphics[width=0.95\linewidth]{observer-sensitivity_files/figure-latex/TimeSeries-4.pdf}
